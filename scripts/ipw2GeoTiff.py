...
ipw_srcdir = sys.argv[1]

ipw_outputdir = ipw_srcdir + "bill_tiffs/" # "/home/william/IPW/output/"

#An example processing the SNO data; could do the same for EM data
ipw_src= [f for f in os.listdir(ipw_srcdir)
          if os.path.isfile(os.path.join(ipw_srcdir, f))]
print os.listdir(ipw_srcdir)
...
for j in ipw_src:
    ...
    print "trying to do ipwfile on inputfilePath = " + inputfilePath
